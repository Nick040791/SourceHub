...
/** Compact lime mark — Style D mock brand (not a busy SH tile). */
...
export const AppHeader: React.FC<AppHeaderProps> = ({
  ...
  return (
    <header className="bg-hub-surface border-b border-hub-border sticky top-0 z-40 px-5 py-3 text-sm">
          ...
          >
            ...
            <div className="flex flex-col min-w-0 leading-tight">
              <div className="flex items-center gap-2">
                <span className="font-semibold text-hub-text text-[15px] tracking-tight">SourceHub</span>
                <span className="px-1.5 py-0.5 text-[9px] font-semibold tracking-[0.08em] uppercase text-hub-success-text/90 bg-hub-accent/5 rounded-full border border-hub-accent/25">
                  Solo Forge
                </span>
              </div>
              <span className="text-[10px] text-hub-muted/80 font-mono mt-0.5">self-hosted • local</span>
            </div>
          </div>
